...
function addNewGroupToMenu(menuPopupConfig) {
    menuPopupConfig.addGroups.forEach(function (groupToAdd) {
        ...
        if (
            jazz.app.currentApplication.ui.navbar._pageList._menuPopupsById[
                menuPopupConfig.id
            ]._currentMenu._wrappedInstance._groups.findIndex(function (group) {
            ...
            jazz.app.currentApplication.ui.navbar._pageList._menuPopupsById[
                menuPopupConfig.id
            ]._currentMenu._wrappedInstance.clearGroup(groupToAdd.id);
        } else {
            ...
            var addAfterGroupIndex = jazz.app.currentApplication.ui.navbar._pageList._menuPopupsById[
                menuPopupConfig.id
            ]._currentMenu._wrappedInstance._groups.findIndex(function (group) {
            ...
            if (addAfterGroupIndex) {
                ...
                customAddGroup.call(
                    jazz.app.currentApplication.ui.navbar._pageList._menuPopupsById[menuPopupConfig.id]._currentMenu
                        ._wrappedInstance,
                    groupToAdd.id,
                    groupToAdd.title,
                ...
                jazz.app.currentApplication.ui.navbar._pageList._menuPopupsById[
                    menuPopupConfig.id
                ]._currentMenu._wrappedInstance.addGroup(groupToAdd.id, groupToAdd.title);
            }
        }
        ...
        menuItems.forEach(function (newItem) {
            jazz.app.currentApplication.ui.navbar._pageList._menuPopupsById[
                menuPopupConfig.id
            ]._currentMenu._wrappedInstance.addItemToGroup(groupToAdd.id, {
                label: newItem.label,
...
function addGroupWhenTypesAreLoaded(menuPopupConfig) {
    (function tryToAdd(menuPopupConfig) {
        ...
        if (
            jazz.app.currentApplication.ui.navbar._pageList._menuPopupsById[menuPopupConfig.id]._currentMenu
                ._wrappedInstance.isTypesLoaded
        ) {
...
dojo.connect(dijit.popup, "open", function (arg) {
    ...
    config.menuPopups.forEach(function (menuPopupConfig) {
        ...
        try {
            typeofCurrentMenu =
                typeof jazz.app.currentApplication.ui.navbar._pageList._menuPopupsById[menuPopupConfig.id]._currentMenu;
        } catch (e) {
        ...
        if (
            ...
            if (
                ...
                jazz.app.currentApplication.ui.navbar._pageList._menuPopupsById[
                    menuPopupConfig.id
                ]._currentMenu._loaded.then(function () {
                    addGroupWhenTypesAreLoaded(menuPopupConfig);
                });
            }
        }
