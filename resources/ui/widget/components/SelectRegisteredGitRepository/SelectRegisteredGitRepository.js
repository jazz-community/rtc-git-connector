...
], function (declare, array, MainDataStore, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, Select, template) {
    return declare(
        "com.siemens.bt.jazz.workitemeditor.rtcGitConnector.ui.widget.selectRegisteredGitRepository",
        [_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin],
        {
            ...
            setEventHandlers: function () {
                ...
                this.selectRegisteredGitRepository.onChange = function (value) {
                    ...
                    if (!selectedRepository || selectedRepository.key !== value) {
                        ...
                        if (
                            self.mainDataStore.selectedRepositoryData.commitsToLink.length > 0 ||
                            ...
                            if (
                                confirm(
                                    "Changing the repository will result in losing your unsaved changes. Are you sure you want to discard your changes?"
                                )
                            ) {
            ...
            createLabelString: function (firstLine, secondLine) {
                return (
                    '<span class="rtcGitConnectorSelectListSpan rtcGitConnectorSelectListFirstLine">' +
                    firstLine +
                    "</span>" +
                    '<span class="rtcGitConnectorSelectListSpan rtcGitConnectorSelectListSecondLine">' +
                    secondLine +
                    "</span>"
                );
            },
            ...
            setRegisteredGitRepositoriesAsListOptions: function (registeredGitRepositories) {
                if (!registeredGitRepositories.length) {
                    ...
                    array.forEach(
                        ...
                        function (registeredGitRepository) {
            ...
            _setSelectedRepositoryByKey: function (key) {
                this.mainDataStore.selectedRepositorySettings.set(
                    "repository",
                    this.mainDataStore.registeredGitRepositories.find(function (element) {
