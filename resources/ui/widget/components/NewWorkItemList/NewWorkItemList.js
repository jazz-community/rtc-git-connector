define([
...
], function (declare, array, domConstruct, on, _WidgetBase, _TemplatedMixin, registry, template) {
    ...
    var NewWorkItemList = declare(
        "com.siemens.bt.jazz.workitemeditor.rtcGitConnector.ui.widget.newWorkItemList",
        [_WidgetBase, _TemplatedMixin],
        {
            ...
            addToPage: function () {
                try {
                    jazz.app.currentApplication.workbench._pageWidgetCache[
            ...
            _updateSubscriptions: function (newSubscriptionHandles) {
                ...
                if (this.subscriptionHandles.length) {
                    this.subscriptionHandles.forEach(function (oldSubscriptionHandle) {
                        if (
                            !newSubscriptionHandles.some(function (newSubscriptionHandle) {
            ...
            _addNewWorkItemToView: function (workItem) {
                ...
                var newWorkItemRow = domConstruct.create(
                    "a",
                    {
                ...
                if (window.location.href === workItemUrl) {
                    var bulletSpan = domConstruct.create(
                        "span",
                        {
                ...
                domConstruct.create(
                    "span",
                    {
                        innerHTML: " * [New " + workItem.object.attributes.workItemType.label + "] " + workItemSummary
                    },
                    newWorkItemRow
                );
            },
            ...
            _createSuccessMessage: function () {
                ...
                var flexContainer = domConstruct.create(
                    "div",
                    {
                ...
                var queryRow = domConstruct.create(
                    "a",
                    {
                        "class": "rtcGitConnectorNewWorkItemListRow",
                ...
                var removeButton = domConstruct.create(
                    "button",
                    {
            ...
            _createNewWorkItemsQuery: function () {
                ...
                var tagsExpression = new AttributeExpression("internalTags", new Operator("is", null), [
                    new UIItem("from-git-issue")
                ]);
