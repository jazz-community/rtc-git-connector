...
], function (declare, lang, MainDataStore, _WidgetBase, _TemplatedMixin, template) {
    var WorkItemOverview = com.ibm.team.workitem.web.ui.internal.view.editor.WorkItemOverview;

    return declare(
        "com.siemens.bt.jazz.workitemeditor.rtcGitConnector.ui.widget.setNewWorkItemAttributes",
